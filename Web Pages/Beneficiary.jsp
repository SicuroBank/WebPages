...
<h1>Add New Beneficiary</h1>
  <body>
      <div class="center">
          ...
          <c:input type="text" placeholder="Enter Account No." name="baccno" path="benAccNo"/>
          <br></br>
          <label for="renterbaccno"><b>Re-Enter Account No.</b></label>
          <c:input type="text" placeholder="Re-Enter Account No." name="renterbaccno" path=""/>
          <br></br>
        <label for="benname"><b>Beneficiary Name</b></label>
        <c:input type="text" placeholder="Enter Name" name="benname"  path="benName"/>
      <br></br>
        <input type="checkbox">Save Beneficiary
        <br></br>
        <label for="nick"><b>Nickname</b></label>
        <c:input type="text" placeholder="Nickname" name="nick"  path="benNickName"/>
        <br></br>
